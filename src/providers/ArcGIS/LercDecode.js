...
export const LercDecode = (function () {
...
var Lerc2Decode = (function () {
  ...
  var BitStuffer = {
    ...
    unstuffLUT: function (src, bitsPerPixel, numPixels, offset, scale, maxValue) {
      var bitMask = (1 << bitsPerPixel) - 1
      var i = 0; var o = 0; var missingBits = 0; var bitsLeft = 0; var n = 0
      var buffer
      var dest = []
    ...
    unstuffLUT2: function (src, bitsPerPixel, numPixels, offset, scale, maxValue) {
      var bitMask = (1 << bitsPerPixel) - 1
      var i = 0; var o = 0; var missingBits = 0; var bitsLeft = 0; var n = 0; var bitPos = 0
      var buffer
      var dest = []
      var nmax = Math.ceil((maxValue - offset) / scale)
      for (o = 0; o < numPixels; o++) {
  ...
  var Lerc2Helpers = {
    ...
    computeChecksumFletcher32: function (input) {
      var sum1 = 0xffff; var sum2 = 0xffff
    ...
    readDataOneSweep: function (input, data, OutPixelTypeArray) {
      ...
      } else // mask
      {
        ...
        var z = 0; var k = 0; var i = 0; var nStart = 0
        if (numDims > 1) {
          for (i = 0; i < numDims; i++) {
            nStart = i * numPixels
            for (k = 0; k < numPixels; k++) {
    ...
    readHuffmanTree: function (input, data) {
      ...
      var bitPos = 0; var word; var srcPtr = 0
      word = stuffedData[0]
      for (i = i0; i < i1; i++) {
        j = i - (i < size ? 0 : size)// wrap around
      ...
      /* ************************
           * building lut
           *************************/
      var numBitsLUT = 0; var numBitsLUTQick = 0
      ...
      var decodeLut = []; var entry; var code; var numEntries; var jj; var currentBit; var node
      for (i = i0; i < i1; i++) {
        j = i - (i < size ? 0 : size)// wrap around
        len = codeTable[j].first
        if (len > 0) {
    ...
    readHuffman: function (input, data, OutPixelTypeArray) {
      ...
      /*************************
          *  decode
          ***************************/
      var node; var val; var delta; var mask = data.pixels.resultMask; var valTmp; var valTmpQuick; var currentBit
      var i, j, k, ii
      var prevVal = 0
      if (bitPos > 0) {
        srcPtr++
    ...
    decodeBits: function (input, data, blockDataBuffer, offset, iDim) {
      {
        ...
        var doLut = (headerByte & 32) > 0// 5th bit
    ...
    readTiles: function (input, data, OutPixelTypeArray) {
      ...
      data.pixels.ptr = 0
      var row = 0; var col = 0; var blockY = 0; var blockX = 0; var thisBlockHeight = 0; var thisBlockWidth = 0; var bytesLeft = 0; var headerByte = 0; var bits67 = 0; var testCode = 0; var outPtr = 0; var outStride = 0; var numBytes = 0; var bytesleft = 0; var z = 0; var blockPtr = 0
      ...
      var numDims = headerInfo.numDims; var iDim
      var mask = data.pixels.resultMask
...
var Lerc = {
  ...
  decode: function (encodedData, options) {
    ...
    var iPlane = 0; var eof = encodedData.byteLength - 10; var encodedMaskData; var bandMasks = []; var bandMask; var maskData
